...
<tr><td style="vertical-align:middle"><b>S.N.</b></td><td style="vertical-align:middle"><b>اسم الاختبار</b></td><td style="vertical-align:middle"><b>عدد الاسئلة الكلي</b></td><td style="vertical-align:middle"><b>درجة الاسئلة الصحيحه</b></td><td style="vertical-align:middle"><b>درجة الاسئلة الخاطئة</b></td><td style="vertical-align:middle"><b>الدرجات الكلية</b></td><td style="vertical-align:middle"><b>الوقت</b></td><td style="vertical-align:middle"><b>Action</b></td></tr>';
    $c = 1;
...
var countdownTimer = setInterval(\'secondPassed()\', 1000);
            ...
            echo '<font size="3" style="margin-left:100px;font-family:\'typo\' font-size:20px; font-weight:bold;color:darkred">Time Left : </font><span class="timer btn btn-default" style="margin-left:20px;"><font style="font-family:\'typo\';font-size:20px;font-weight:bold;color:darkblue" id="countdown"></font></span><span class="timer btn btn-warning" style="margin-left:50px;float:right;position:relative;left:-59px;top:6px;" onclick="end()">&nbsp;&nbsp;<font style="font-size:12px;font-weight:bold;padding-right:3px;">انهاء الامتحان</font><span class=" glyphicon glyphicon-off"></span></span>';
            $eid   = @$_GET['eid'];
            $sn    = @$_GET['n'];
            $total = @$_GET['t'];
            ...
            while ($row = mysqli_fetch_array($q)) {
                ...
                $qid = $row['qid'];
                echo '<b><pre class="q-title" style="background-color:white"><div style="font-size:20px;font-weight:bold;font-family:calibri;margin:10px">' . $sn . ' : ' . $qns . '</div></pre></b>';
            }
...
<br />';
            ...
            if (strlen($ans) > 0) {
                echo "<font class='q-test1' style=\"color:green;font-size:12px;font-weight:bold\">Your answer:</font><font style=\"color:#565252;font-size:12px;\">" . $ans . "</font>&nbsp;&nbsp;<a href=update.php?q=quiz&step=2&eid=$eid&n=$sn&t=$total&qid=$qid&delanswer=delanswer><span class=\"glyphicon glyphicon-remove\" style=\"font-size:12px;color:darkred\"></span></a><br /><br />";
            }
            ...
            while ($row = mysqli_fetch_array($q)) {
                ...
                echo '<div class="funkyradio-success"><input type="radio" id="' . $optionid . '" name="ans" value="' . $optionid . '" onclick="enable()"> <label class="q-option" for="' . $optionid . '" style="/*width:100%*/"><div style="color:black;font-size:12px;word-wrap:break-word;font-weight:bold;">&nbsp;&nbsp;' . $option . '</div></label></div>';
            }
            echo '</div>';
            if ($_GET["t"] > $_GET["n"] && $_GET["n"] != 1) {
                ...
                echo '<br />&nbsp;&nbsp;&nbsp;&nbsp;<button type="submit" class="btn btn-default" disabled="true" id="sbutton" style="height:30px"><span class="glyphicon glyphicon-lock" style="font-size:12px" aria-hidden="true"></span><font style="font-size:12px;font-weight:bold"> Lock<font></button>&nbsp;&nbsp;&nbsp;&nbsp;<button type="button" class="btn btn-default" onclick="frmreset()" style="height:30px"></span><font style="font-size:12px;font-weight:bold">Reset</font></button>&nbsp;&nbsp;&nbsp;&nbsp;<a id="btn-next" href="account.php?q=quiz&step=2&eid=' . $eid . '&n=' . ($sn + 1) . '&t=' . $total . '" class="btn btn-primary" style="height:30px"><span class="glyphicon glyphicon-arrow-right" aria-hidden="true"  style="font-size:12px"></span></a></form><br><br>';
            } else {
            }
            echo '</div>';
            echo '<div id="panel-qs" class="panel" style="text-align:center">';
            ...
            for ($i = 1; $i <= $total; $i++) {
                echo '<a class="lnk-qs btn btn-success" href="account.php?q=quiz&step=2&eid=' . $eid . '&n=' . $i . '&t=' . $total . '"  style="margin:5px;padding:5px;background-color:';
                if ($quesans[$i]) {
                    echo "darkgreen";
                } else {
                    echo "darkred";
...
<a href="#" data-toggle="modal" data-target="#developers" s style="color:lightyellow;" onmouseover="this.style('color:yellow')" target="new">Developed by Abdulrahman Mohamed</a>
</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" style="font-family:'typo' "><span style="color:orange">Abdulrahman Mohamed</span></h4>
      </div>
      ...
      <div class="modal-body">
		...
		<div class="col-md-4">
		 ...
		 <div class="col-md-5">
		<a href="" style="color:#202020; font-family:'typo' ; font-size:18px" title="">Abdulrahman Mohamed</a>
		<h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+20 01011 626 776</h4>
		<h4 style="font-family:'typo' ">abdo3@email.com</h4>
		<h4 style="font-family:'typo' ">Web Programer </h4></div></div>
		</p>
      </div>
